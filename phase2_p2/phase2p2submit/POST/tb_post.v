...
module tb();
`define IPNUT_FILE_NAME "ddr2_test_pattern0.dat"
`define TRACE_FILE_NAME "ddr2_test.trc"  //Not used 
`define DUMP_FILE_NAME  "ddr2_out00.dump"
...
initial begin
	$sdf_annotate("/home/scf-12/cma290/577b/syn/sdf/ddr2_controller.sdf",XCON,,,"TYPICAL","1.0:1.0:1.0", "FROM_MTM");
end
   initial
	 begin
